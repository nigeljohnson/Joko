...
//Elements Fading
	$('.element_from_top').each(function () {
		$(this).appear(function() {
		  $(this).delay(450).animate({opacity:1,top:"0px"},1300);
		});	
	});
	
	$('.element_from_bottom').each(function () {
		$(this).appear(function() {
		  $(this).delay(450).animate({opacity:1,bottom:"0px"},1300);
		});	
	});
	...
	$('.element_from_left').each(function () {
		$(this).appear(function() {
		  $(this).delay(450).animate({opacity:1,left:"0px"},1300);
		});	
	});
	...
	$('.element_from_right').each(function () {
		$(this).appear(function() {
		  $(this).delay(450).animate({opacity:1,right:"0px"},1300);
		});	
	});
